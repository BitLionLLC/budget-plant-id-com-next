          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-x-10 gap-y-3 text-sm sm:grid-cols-3">
              ...
              <FooterCol title="Legal">
                <FooterLink href={site.privacyUrl} external>
                  Privacy policy
                </FooterLink>
                <FooterLink href={site.eulaUrl} external>
                  Terms of use
                </FooterLink>
...
function FooterCol({
  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="text-xs font-semibold tracking-[0.14em] uppercase opacity-60">
        {title}
      </p>
      {children}
    </div>
...
function FooterLink({
  ...
  const className =
    "text-soft transition hover:text-[color:var(--text)] w-fit";
  return external ? (
    <a
      href={href}
      target="_blank"
